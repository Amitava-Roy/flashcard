...
function CardDetails() {
  ...
  return (
    <>
      ...
      <section className="flex gap-3 flex-col md:flex-row md:flex-[25%_50%_25%] first-letter:uppercase">
        <div className="flex flex-col gap-4 first-letter:uppercase items-center bg-stone-50 shadow-sm p-5 pt-6 rounded-lg">
          <p className="self-center md:self-start border-b-2 text-base text-slate-500/100 font-semibold">
            Flashcards
          </p>
          {cards.map((item, i) => (
            <button
        ...
        <div className="flex flex-col-reverse md:flex-row-reverse flex-grow gap-6 items-center text-center md:text-start md:justify-end bg-stone-50 shadow-sm p-5 pt-6 rounded-lg">
          <FlashCardDetails activeCard={activeCard} />
        </div>
        <div className="flex flex-row md:flex-col gap-3 text-blue-500/100">
          <button
